...
//
// Basic example app to show how cookies are used to maintain
// state for each client.
// Once running, go to any path -- e.g., `/foo`, `/bar`
// to observe how many times the path was visited by the client.
//
// Set DISABLE_SESSION = true to demonstrate how maintaining per-client state
// is not possible without cookies.
