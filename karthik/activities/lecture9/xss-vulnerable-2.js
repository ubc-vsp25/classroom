...
// 
// Type in something like <script>alert("You are attacked!")</script>
// in the text input to mount a XSS attack.
// The user input is not sanitized and it is rendered verbatim
// in the HTML, resulting in executing the script entered by the user.
// 
// IMPORTANT: This program generates a temporary file named temp-bad.data
